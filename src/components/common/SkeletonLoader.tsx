          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div className="space-y-1.5">
                <div className="w-20 h-3.5 bg-slate-800 rounded-md" />
                <div className="w-12 h-2.5 bg-slate-800/60 rounded-md" />
              </div>
            </div>
            <div className="w-14 h-5 bg-slate-800 rounded-lg" />
          </div>

          <div className="p-3 rounded-xl bg-slate-950/60 space-y-1.5">
            <div className="w-16 h-2.5 bg-slate-800/60 rounded-md" />
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 space-y-4 animate-pulse">
      <div
        ...
        className="rounded-full border-8 border-slate-800 flex items-center justify-center"
      >
        <div className="space-y-1.5 text-center">
          <div className="w-16 h-3 bg-slate-800 rounded-md mx-auto" />
          <div className="w-24 h-4 bg-slate-800 rounded-md mx-auto" />
        </div>
      </div>
    </div>
  );
