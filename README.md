...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/پلتفرم-PWA%20%7C%20Android-indigo?style=for-the-badge" alt="Platform">
...
## 📲 نحوه دریافت و نصب برنامه روی گوشی (اندروید)

### ۱. دانلود مستقیم فایل نصبی APK (توصیه‌شده):
1. از ستون سمت راست یا بالای همین مخزن در گیت‌هاب وارد بخش **[Releases](../../releases)** شوید.
2. آخرین نسخه فایل نصبی با پسوند **`.apk`** (مانند `Investment-App-v1.0.0.apk`) را دانلود کرده و روی گوشی اندرویدی خود نصب نمایید.

### ۲. اجرا در مرورگر به عنوان وب‌اپلیکیشن (PWA):
1. لینک برنامه را در مرورگر **Google Chrome** گوشی باز کنید.
2. روی علامت سه نقطه در بالای مرورگر بزنید و گزینه **Install app (نصب برنامه)** یا **Add to Home screen** را انتخاب کنید.
