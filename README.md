...
6. وارد اپلیکیشن مدیریت سرمایه شوید، در تب **«ارز دیجیتال»** دکمه **«اتصال به نوبیتکس»** را لمس کنید و کلیدها را در کادرهای مربوطه قرار داده و دکمه **«ذخیره و همگام‌سازی»** را بزنید.
