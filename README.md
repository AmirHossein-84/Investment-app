...
#### روش ۱ (ساده‌ترین روش - بدون نیاز به رایانه و بدون هزینه):
1. لینک **GitHub Pages** این مخزن را در مرورگر **Safari** آیفون خود باز کنید.
...
3. گزینه **Add to Home Screen (افزودن به صفحه اصلی)** را انتخاب کنید.
   *(برنامه مانند یک اپلیکیشن بومی با آیکون اختصاصی و بدون منوهای مرورگر روی صفحه اصلی قرار می‌گیرد و به صورت آفلاین کار می‌کند).*
...
2. با یکی از نرم‌افزارهای رایگان و محبوب زیر فایل را روی آیفون خود نصب کنید:
   - **Sideloadly** (نرم‌افزار رایگان کامپیوتر برای ویندوز و مک - فقط با درگ کردن فایل IPA)
   - **AltStore** یا **SideStore** (بدون نیاز به کابل و تمدید خودکار)
