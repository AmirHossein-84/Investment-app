...
## 📲 نحوه نصب برنامه روی گوشی

### روی آیفون (iOS):
1. لینک برنامه را در مرورگر **Safari** باز کنید.
2. دکمه **Share** (آیکون اشتراک‌گذاری پایین صفحه) را لمس کنید.
3. گزینه **Add to Home Screen (افزودن به صفحه اصلی)** را انتخاب کنید.

### روی گوشی‌های اندروید (Android):
1. لینک برنامه را در مرورگر **Chrome** باز کنید.
2. روی علامت سه نقطه در بالا بزنید و گزینه **Install app (نصب برنامه)** را انتخاب کنید.
3. یا فایل نصبی بومی **APK** را مستقیماً دانلود و نصب نمایید.
